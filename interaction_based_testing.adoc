...
----
  }/interaction/InteractionDocSpec.groovy[tag=examplesetup]
}
----
...
[source,groovy,indent=0]
----
  }/interaction/InteractionDocSpec.groovy[tag=mock1]
----
...
[source,groovy,indent=0]
----
  }/interaction/InteractionDocSpec.groovy[tag=mock2]
----
...
[source,groovy,indent=0]
----
  }/interaction/InteractionDocSpec.groovy[tag=example1]
----
...
[source,groovy,indent=0]
----
  }/interaction/InteractionDocSpec.groovy[tag=example2]
----
...
[source,groovy,indent=0]
----
  }/interaction/InteractionDocSpec.groovy[tag=argConstraints]
----
...
[source,groovy,indent=0]
----
  }/interaction/InteractionDocSpec.groovy[tag=codeConstraint]
----
...
[source,groovy,indent=0]
----
  }/interaction/InteractionDocSpec.groovy[tag=anyConstraints]
----
...
[source,groovy,indent=0]
----
  }/interaction/InteractionDocSpec.groovy[tag=example3]
----
...
block. (Fans of <<data_driven_testing.adoc#data-driven-testing,Data Driven Testing>> might move the variable into a `where:` block.)
...
[source,groovy,indent=0]
----
  }/interaction/InteractionDocSpec.groovy[tag=example4]
----
...
[source,groovy,indent=0]
----
  }/interaction/InteractionDocSpec.groovy[tag=example5]
----
...
[source,groovy,indent=0]
----
  }/interaction/InteractionDocSpec.groovy[tag=spy1]
----
