...
----
  }/datadriven/v1/MathSpec.groovy[tag=example]
----
...
[source,groovy,indent=0]
----
  }/datadriven/v2/MathSpec.groovy[tag=example-a]
    ...
  }/datadriven/v2/MathSpec.groovy[tag=example-b]
----
...
[source,groovy,indent=0]
----
  }/datadriven/v2/MathSpec.groovy[tag=example]
----
...
[source,groovy,indent=0]
----
  }/datadriven/DataSpec.groovy[tag=single-column]
----
...
[source,groovy,indent=0]
----
  }/datadriven/DataSpec.groovy[tag=multiple-tables]
----
...
[source,groovy,indent=0]
----
  }/datadriven/DataSpec.groovy[tag=multiple-tables-combined]
----
...
[source,groovy,indent=0]
----
  }/datadriven/DataSpec.groovy[tag=multiple-tables-with-top-border]
----
...
[source,groovy,indent=0]
----
  }/datadriven/v3/MathSpec.groovy[tag=example]
----
...
[source,groovy,indent=0]
----
  }/datadriven/v6/MathSpec.groovy[tag=example]
----
...
[source,groovy,indent=0]
----
  }/datadriven/v7/MathSpec.groovy[tag=example]
----
...
[source,groovy,indent=0]
----
  }/datadriven/v4/MathSpec.groovy[tag=example]
  ...
----
...
----
    ...
  }/datadriven/DataSpec.groovy[tag=data-pipes]
----
...
[source,groovy,indent=0]
----
  }/datadriven/DataSpec.groovy[tag=datasource]

  }/datadriven/DataSpec.groovy[tag=sql-data-pipe]
----
...
----
    ...
  }/datadriven/DataSpec.groovy[tag=sql-data-pipe-with-underscore]
----
...
----
    ...
  }/datadriven/DataSpec.groovy[tag=nested-multi-variable-data-pipe]
----
...
----
    ...
  }/datadriven/DataSpec.groovy[tag=data-variable-assignment]
----
...
----
    ...
  }/datadriven/DataSpec.groovy[tag=sql-data-variable-assignment]
----
...
----
    ...
  }/datadriven/DataSpec.groovy[tag=previous-column-access]
----
...
----
    ...
  }/datadriven/DataSpec.groovy[tag=previous-column-access-multi-table]
----
...
----
  ...
  }/datadriven/DataSpec.groovy[tag=sql-multi-assignment]
----
...
----
    ...
  }/datadriven/DataSpec.groovy[tag=sql-multi-assignment-with-underscore]
----
...
----
    ...
  }/datadriven/DataSpec.groovy[tag=combined-variable-assignment]
----
...
[source,groovy,indent=0]
----
  }/datadriven/DataSpec.groovy[tag=type-coercion]
----
[source,groovy,indent=0]
----
  }/datadriven/DataSpec.groovy[tag=type-coercion-with-custom-coercion]
----
...
[source,groovy,indent=0]
----
  }/datadriven/v5/MathSpec.groovy[tag=example]
  ...
----
...
[source,groovy,indent=0]
----
  }/datadriven/DataSpec.groovy[tag=unrolled-1]
  }/datadriven/DataSpec.groovy[tag=unrolled-2]
----
...
[source,groovy,indent=0]
----
  }/datadriven/DataSpec.groovy[tag=unrolled-3a]
    ...
  }/datadriven/DataSpec.groovy[tag=unrolled-3b]
----
