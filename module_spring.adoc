...
----
  -spring}/DetachedJavaConfig.groovy[tag=javaconfig]
----
...
[source,groovy,indent=0]
----
  -spring}/MockExamples.groovy[tag=example]
----
...
[source,groovy,indent=0]
----
  -spring}/SpringBeanExamples.groovy[tag=example]
----
...
[source,groovy,indent=0]
----
  -spring}/SpringSpyExamples.groovy[tag=example]
----
...
[source,groovy,indent=0]
----
  -spring}/StubBeansExamples.groovy[tag=example]
----
...
[source,groovy,indent=0]
----
  -spring-boot}/WebMvcTestIntegrationSpec.groovy[tag=include]
----
