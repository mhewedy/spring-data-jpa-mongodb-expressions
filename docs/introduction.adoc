...
.How it works
****
__Spring Data JPA MongoDB Expressions__ converts the MongoDB queries into SQL queries. So the following MongoDB query:
[source,json]
----
{
  "status": "A",
...
----
TIP: You can create MongoDB queries using simple javascript code link this one https://playcode.io/814121/[here,role=external,window=_blank]
****
